    ...
    <div class="container py-5">
      ...
      <div v-if="step === 2" class="review-step">
        ...
        <div class="d-flex justify-content-between">
          <button class="btn btn-outline-secondary btn-lg px-4" @click="step = 1">
...
const saveExercise = async (publish = false) => {
  ...
  try {
    ...
    if (error.code === 'ECONNABORTED' || error.message?.includes('timeout')) {
      errorMessage = 'La requête a pris trop de temps. Veuillez vérifier que le serveur backend est démarré et réessayer.'
